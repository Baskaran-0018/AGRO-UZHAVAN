...
export function generateSyntheticCropPlan(
  ...
  const WEEKLY_TASKS_MAP: Record<SupportedLang, { day: string; task: string; category: string }[]> = {
    ...
    gu: [
      { day: 'સોમવાર', task: 'ડ્રિપ લાઇન પાસે નીંદણ દૂર કરવું અને જમીનની ગોડ કરવી', category: 'જમીન સ્વાસ્થ્ય' },
      { day: 'બુધવાર', task: 'પાંદડા પર સૂક્ષ્મ પોષકતત્વોનો છંટકાવ (ઝિંક + બોરોન + મેગ્નેશિયમ)', category: 'પોષણ વ્યવસ્થાપન' },
      { day: 'શુક્રવાર', task: 'ડ્રિપ ફિલ્ટર સાફ કરવું અને પાણીના દબાણની ચકાસણી', category: 'પિયત' },
      { day: 'રવિવાર', task: 'સાપ્તાહિક પાક વૃદ્ધિ અને ડાળીઓની સંખ્યા તપાસવી', category: 'ખેતર ઓડિટ' }
    ],
    pa: [
      { day: 'ਸੋਮਵਾਰ', task: 'ਡ੍ਰਿਪ ਲਾਈਨਾਂ ਦੇ ਨੇੜੇ ਨਦੀਨਾਂ ਦੀ ਰੋਕਥਾਮ ਅਤੇ ਗੋਡੀ ਕਰਨਾ', category: 'ਮਿੱਟੀ ਦੀ ਸਿਹਤ' },
      { day: 'ਬੁੱਧਵਾਰ', task: 'ਪੱਤਿਆਂ ਤੇ ਸੂਖਮ ਤੱਤਾਂ ਦਾ ਛਿੜਕਾਅ (ਜ਼ਿੰਕ + ਬੋਰੋਨ + ਮੈਗਨੀਸ਼ੀਅਮ)', category: 'ਖੁਰਾਕ ਪ੍ਰਬੰਧਨ' },
      { day: 'ਸ਼ੁੱਕਰਵਾਰ', task: 'ਡ੍ਰਿਪ ਫਿਲਟਰ ਸਾਫ਼ ਕਰਨਾ ਅਤੇ ਪਾਣੀ ਦੇ ਵਹਾਅ ਦੀ ਜਾਂਚ', category: 'ਸਿੰਚਾਈ' },
      { day: 'ਐਤਵਾਰ', task: 'ਹਫ਼ਤਾਵਾਰੀ ਫਸਲ ਦਾ ਵਾਧਾ ਅਤੇ ਸ਼ਾਖਾਵਾਂ ਦੀ ਗਿਣਤੀ', category: 'ਫਾਰਮ ਆਡਿਟ' }
    ],
    en: [
